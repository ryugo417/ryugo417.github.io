...
![compare](ryugo417.github.io/detail/img/ManiTrans_model.png) 
...
![compare](ryugo417.github.io/detail/img/ManiTrans_quality.png) 

また、CUBとOxfordの融合データセットを作ることで、
花→鳥、鳥→花のimage manipulationgaが可能になった。

![compare](ryugo417.github.io/detail/img/ManiTrans_quality_change.png) 
